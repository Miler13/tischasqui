...
ALTER TABLE `escribir_subareas`
  ...
  ADD KEY `fk_escribir_subareas_cartas1_idx` (`cartas_idcartas`);
...
--
ALTER TABLE `escribir_subareas`
  ADD CONSTRAINT `fk_escribir_subareas_cartas1` FOREIGN KEY (`cartas_idcartas`) REFERENCES `cartas` (`idcartas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
