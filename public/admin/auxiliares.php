        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
				...
				<div class="col-md-10"><input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese su(s) nombre(s)" onkeypress="return sololetras(event)" required maxlength="50"minlength="3"></div>
			   </div><br>
			   <div class="form-group"> <label for="apellido" class="col-md-2 control-label">Apellidos:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="apellido" name="apellido" placeholder="Ingrese su(s) apellido(s)" onkeypress="return sololetras(event)" required maxlength="50"minlength="3"></div>
			   </div><br>
         <div class="form-group"> <label for="cedula" class="col-md-2 control-label">CI:</label>
			   ...
			   <div class="form-group"> <label for="celular" class="col-md-2 control-label">Telefono:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="celular" name="celular" placeholder="Ingrese su telefono fijo o movil" onkeypress="return solonumeros(event)" required maxlength="8" minlength="6"></div>
			   </div><br>
