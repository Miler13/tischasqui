<?php
//$con = mysqli_connect("localhost","root","elier123","Sistema de Laboratorios de informatica-sistemas UMSS");
...
$filename = $folder."Sistema de Laboratorios de informatica-sistemas UMSS_backup_".$date; 
