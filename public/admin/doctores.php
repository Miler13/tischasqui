...
<head>
    ...
    <script src="doctores/myjava.js"></script>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Doctores</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               ...
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el Nombre del Doctor" onkeypress="return sololetras(event)">
		               	...
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Doctor</button> 
