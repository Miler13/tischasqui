...
<head>
    ...
    <script src="cartas/funciones.js"></script>
    <script src="../admin/validar.js"></script>

    <!-- no hay archivo en esas direcciones -->
    ...
    <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/logo.JPG" width="80" height="80" class="img-responsive"></div>
             ...
             <img class="img-responsive img-circle" src="<?php echo $foto ?>" width="50px" height="50px">
              <h5><i class="fa fa-circle fa-stack-1x fa-inverse" style="color:green; text-align: left; "></i><b> &nbsp; Online:</b> <?php echo $nino ?></h5>
               </div> 
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Cartas</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el titulo" disabled>
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nueva carta</button> 
		               </div>
	              <br>
 <br>
    ...
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM cartas"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-lock'></i>&nbsp;&nbsp;Cartas</b></h4>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
			   ...
			   <div class="form-group"> <label for="contenido" class="col-md-2 control-label">Contenido:</label>
				<div class="col-md-10"><textarea type="text" class="form-control" id="contenido" name="contenido" placeholder="Ingrese contenido" required rows="8"></textarea></div>
               </div>
            ...
            <input type="submit" value="Envia carta" class="btn btn-success" id="reg"/>
                <input type="submit" value="Edita carta" class="btn btn-warning"  id="edi"/>
